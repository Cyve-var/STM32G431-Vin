...
#define STM32G431_GPIOB_MODER_RESET_VALUE 0xFFFFFEBF
typedef struct {
...
} sSTM32G431_GPIOB_MODER;

typedef union {
    sSTM32G431_GPIOB_MODER Bit;
    unsigned long  All;
} uSTM32G431_GPIOB_MODER;

#define STM32G431_GPIOB_OTYPER_RESET_VALUE 0x00000000
typedef struct {
    unsigned long OT0 : 1;
    unsigned long OT1 : 1;
    unsigned long OT2 : 1;
...
} sSTM32G431_GPIOB_OTYPER;

typedef union {
    sSTM32G431_GPIOB_OTYPER Bit;
    unsigned long  All;
} uSTM32G431_GPIOB_OTYPER;

#define STM32G431_GPIOB_OSPEEDR_RESET_VALUE 0x000000C0
typedef struct {
...
} sSTM32G431_GPIOB_OSPEEDR;

typedef union {
    sSTM32G431_GPIOB_OSPEEDR Bit;
    unsigned long  All;
} uSTM32G431_GPIOB_OSPEEDR;

#define STM32G431_GPIOB_PUPDR_RESET_VALUE 0x00000100
typedef struct {
...
} sSTM32G431_GPIOB_PUPDR;

typedef union {
    sSTM32G431_GPIOB_PUPDR Bit;
    unsigned long  All;
} uSTM32G431_GPIOB_PUPDR;

#define STM32G431_GPIOB_IDR_RESET_VALUE 0x00000000
typedef struct {
    ...
    unsigned long Res0 : 16;
} sSTM32G431_GPIOB_IDR;

typedef union {
    sSTM32G431_GPIOB_IDR Bit;
    unsigned long  All;
} uSTM32G431_GPIOB_IDR;

#define STM32G431_GPIOB_ODR_RESET_VALUE 0x00000000
typedef struct {
    ...
    unsigned long Res0 : 16;
} sSTM32G431_GPIOB_ODR;

typedef union {
    sSTM32G431_GPIOB_ODR Bit;
    unsigned long  All;
} uSTM32G431_GPIOB_ODR;

#define STM32G431_GPIOB_BSRR_RESET_VALUE 0x00000000
typedef struct {
    unsigned long BS0 : 1;
    unsigned long BS1 : 1;
    unsigned long BS2 : 1;
...
} sSTM32G431_GPIOB_BSRR;

typedef union {
    sSTM32G431_GPIOB_BSRR Bit;
    unsigned long  All;
} uSTM32G431_GPIOB_BSRR;

#define STM32G431_GPIOB_LCKR_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32G431_GPIOB_LCKR;

typedef union {
    sSTM32G431_GPIOB_LCKR Bit;
    unsigned long  All;
} uSTM32G431_GPIOB_LCKR;

#define STM32G431_GPIOB_AFRL_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32G431_GPIOB_AFRL;

typedef union {
    sSTM32G431_GPIOB_AFRL Bit;
    unsigned long  All;
} uSTM32G431_GPIOB_AFRL;

#define STM32G431_GPIOB_AFRH_RESET_VALUE 0x00000000
typedef struct {
...
} sSTM32G431_GPIOB_AFRH;

typedef union {
    sSTM32G431_GPIOB_AFRH Bit;
    unsigned long  All;
} uSTM32G431_GPIOB_AFRH;

#define STM32G431_GPIOB_BRR_RESET_VALUE 0x00000000
typedef struct {
    unsigned long BR0 : 1;
    unsigned long BR1 : 1;
    unsigned long BR2 : 1;
    ...
    unsigned long BR15 : 1;
    unsigned long Res0 : 16;
} sSTM32G431_GPIOB_BRR;

typedef union {
    sSTM32G431_GPIOB_BRR Bit;
    unsigned long  All;
} uSTM32G431_GPIOB_BRR;

typedef struct {
    uSTM32G431_GPIOB_MODER STM32G431_GPIOB_MODER; // Offset: 0x0
    uSTM32G431_GPIOB_OTYPER STM32G431_GPIOB_OTYPER; // Offset: 0x4
    uSTM32G431_GPIOB_OSPEEDR STM32G431_GPIOB_OSPEEDR; // Offset: 0x8
    uSTM32G431_GPIOB_PUPDR STM32G431_GPIOB_PUPDR; // Offset: 0xc
    uSTM32G431_GPIOB_IDR STM32G431_GPIOB_IDR; // Offset: 0x10
    uSTM32G431_GPIOB_ODR STM32G431_GPIOB_ODR; // Offset: 0x14
    uSTM32G431_GPIOB_BSRR STM32G431_GPIOB_BSRR; // Offset: 0x18
    uSTM32G431_GPIOB_LCKR STM32G431_GPIOB_LCKR; // Offset: 0x1c
    uSTM32G431_GPIOB_AFRL STM32G431_GPIOB_AFRL; // Offset: 0x20
    uSTM32G431_GPIOB_AFRH STM32G431_GPIOB_AFRH; // Offset: 0x24
    uSTM32G431_GPIOB_BRR STM32G431_GPIOB_BRR; // Offset: 0x28
} sSTM32G431_GPIOB;
